-- Offline sales idempotency.
-- Adds a client-generated idempotency key to vendas and makes
-- criar_venda_completa return the existing sale for repeated keys.
...
comment on column public.vendas.client_sale_id is
  'Client-generated sale idempotency key. Used to safely replay offline sales.';

create unique index if not exists vendas_user_client_sale_id_unique
  on public.vendas (id_usuario, client_sale_id)
