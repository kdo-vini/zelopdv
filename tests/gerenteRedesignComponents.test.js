...
describe('SignalRow', () => {
  it('tem kicker por severidade, números recolhidos, ação rápida e perguntar', async () => {
    ...
    for (const t of ['Precisa de você', 'Fica de olho', 'Pra saber', '<details', 'Ver os números', 'acaoRapida', 'Perguntar', 'Silenciar esse tipo', 'Silenciado nas preferências', 'onQuickAction', 'presenter.acaoRapida && menuAtivo']) expect(s).toContain(t);
