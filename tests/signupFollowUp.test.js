...
const mocks = vi.hoisted(() => ({ ads: vi.fn(), wait: vi.fn(), referral: vi.fn(), identify: vi.fn(), lead: vi.fn(), ga: vi.fn() }));
...
vi.mock('$lib/posthogClient', () => ({ identifyPostHogUser: mocks.identify }));
