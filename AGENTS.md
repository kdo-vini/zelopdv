...
If you need to add a new CSS variable, follow `docs/DESIGN_SYSTEM.md`: primitives go in `src/themes/tokens.css`, semantic values in each `src/themes/surface-*.css` (app, brand and legacy).
