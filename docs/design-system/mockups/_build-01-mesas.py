...
<nav class="bn"><a>{i('bag')}PDV</a><a class="on">{i('table')}Mesas</a><a>{i('grid')}Gestão</a><a>{i('wallet')}Financeiro</a><a>{i('user')}Perfil</a></nav></div>'''
