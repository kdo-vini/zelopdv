...
2. Implementar o adapter de leitura/escrita para `zelomenu_product_publications`, `zelomenu_modifier_groups` e `zelomenu_modifier_options`, sem alterar o catálogo base `produtos`.
