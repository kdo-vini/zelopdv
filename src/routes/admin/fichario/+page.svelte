...
<style>
	...
	.saldo-box .label{color:var(--text-muted);font-size:12px;text-transform:uppercase}
	.saldo-box .value{display:block;color:var(--error);font-size:26px;font-weight:bold}
