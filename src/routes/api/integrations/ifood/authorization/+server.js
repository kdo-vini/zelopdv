...
/** Read-only authorization prompt (state/URL) — safe to poll on refresh. */
export async function GET({ request }) {
  ...
  try {
    const result = await service.getAuthorizationPrompt({
...
/** `{ state }` — confirms authorization against the provider and activates on success. */
