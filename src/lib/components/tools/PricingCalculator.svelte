    ...
    {#if productStep === 2}
      <div class="mode-grid">
        ...
        >
          ...
          <p>
            Melhor para quem já sabe o custo final da receita ou quer um cálculo
            rápido.
          </p>
        </button>
        ...
        >
          ...
          <p>
            Melhor para quando você quer calcular proporção por peso, volume ou
            unidades.
          </p>
        </button>
      </div>
              ...
              <div class="ingredient-row">
                ...
                {#if !isIngredientCompatible(row) && row.purchaseQuantity && row.usageQuantity}
                  <p class="warning-copy">
                    As unidades comprada e usada precisam ser da mesma família.
                  </p>
                {/if}
              </div>
            {/each}
      ...
      <div class="markup-heading">
        ...
        >
          ...
          <span class="info-pop">
            ...
            <br /><br />
            <strong>Margem sobre a venda</strong> — quanto do preço final é lucro
            de verdade. Ex.: R$ 10 de lucro num preço de R$ 20 = 50%.<br />
            Conta: <em>margem = lucro ÷ preço</em>.
            <br /><br />
            Markup de 100% (vender pelo dobro do custo) equivale a 50% de margem.
            A taxa da plataforma é descontada à parte e reduz a margem real.
          </span>
        </button>
      </div>
      ...
      {#if productResultReady}
            ...
            <span class="metric-label-row">
              ...
              >
                ...
                <span class="info-pop">
                  ...
                  lucro. Conta: <em>margem = lucro ÷ preço</em>.
                  <br /><br />
        ...
        <div class="helper-box compact-top">
          ...
          <p>
            ...
            <strong>{formatCurrency(productProfitPerUnit)}</strong> para cada
            <strong>{formatCurrency(productSuggestedPrice)}</strong> vendidos.
          </p>
        </div>
      {:else}
        <div class="empty-state">
          ...
          <p>
            Preencha pelo menos o custo da unidade para exibir os resultados.
          </p>
        </div>
      {/if}
    {/if}

    {#if variant === "marketing" && productStep === 5 && productResultReady}
...
{#if variant === "marketing" && productResultReady}
...
<style>
  ...
  /* Step 2 — destaque do custo total */
  .hero-input-area {
    border-radius: 1.25rem;
