<script>
  ...
  let { name, price = 0, meta = '', quantity = 0, lowStock = null, pricePrefix = 'R$', onclick = () => {} } = $props();
</script>

<button type="button" class="tile" class:in={quantity > 0} {onclick}>
  <span class="head">
...
<style>
  ...
  .nm { font-weight: 500; font-size: 14.5px; line-height: 1.3; }
