...
<style>
  ...
  .briefing-empty { display: grid; gap: 5px; margin-top: 18px; padding: 14px; border: 1px dashed var(--border-strong); border-radius: 6px; color: var(--text-muted); font-size: 13px; line-height: 1.45; }.briefing-empty strong { color: var(--text-label); font-weight: 600; }
</style>
